...
namespace FujitsuCDU.Replenishment
{
    public partial class AddReplenish : Form
    {
        ...
        private void SubscribeCassette1()
        {
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at AddReplenish.SubscribeCassette1", ex);
            }
        ...
        private void SubscribeCassette2()
        {
         ...
         Observable
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at AddReplenish.SubscribeCassette2", ex);
            }
        ...
        private void SubscribeCassette3()
        {
         ...
         Observable
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at AddReplenish.SubscribeCassette3", ex);
            }
        ...
        private void SubscribeCassette4()
        {
          ...
          Observable
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at AddReplenish.SubscribeCassette4", ex);
            }
        ...
        private void SubscribeCassette5()
        {
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at AddReplenish.SubscribeCassette5", ex);
            }
        ...
        private void SubscribeCassette6()
        {
         ...
         Observable
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at AddReplenish.SubscribeCassette6", ex);
            }
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at AddReplenish.btnSubmit_Click", ex);
            }
        }
        ...
        private void ProcessAddReplenish()
        {
            try
            {
                ...
                foreach (var denom in denoms)
                {
                    ...
                    {
                        Logger.LogExceptionWithNoLock($" Exception at AddReplenish.ProcessAddReplenish Inner loop", ex);
                    }
                }
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at AddReplenish.ProcessAddReplenish", ex);
            }
