...
{
    public partial class ResetReplenish : Form
    {
        ...
        private void SubscribeCassette1()
        {
         ...
         Observable
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at ResetReplenish.SubscribeCassette1", ex);
            }
        ...
        private void SubscribeCassette2()
        {
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at ResetReplenish.SubscribeCassette2", ex);
            }
        ...
        private void SubscribeCassette3()
        {
           ...
           Observable
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at ResetReplenish.SubscribeCassette3", ex);
            }
        ...
        Observable
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at ResetReplenish.SubscribeCassette4", ex);
            }
        ...
        private void SubscribeCassette5()
        {
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at ResetReplenish.SubscribeCassette5", ex);
            }
        ...
        Observable
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at ResetReplenish.SubscribeCassette6", ex);
            }
        ...
        private void ResetReplenish_Load(object sender, EventArgs e)
        {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at ResetReplenish.btnSubmit_Click", ex);
            }
        }
        ...
        private void ProcessResetReplenish()
        {
            try
            {
                ...
                foreach (var denom in denoms)
                {
                    ...
                    {
                        Logger.LogExceptionWithNoLock($" Exception at ResetReplenish.ProcessResetReplenish", ex);
                    }
        ...
        public void SendSocketMessage(string message)
        {
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at ResetReplenish.SendSocketMessage", ex);
            }
        }
        ...
        private void CleanObjects()
        {
            ...
            {
                Logger.LogExceptionWithNoLock($" Exception at ResetReplenish.CleanObjects", ex);
            }
